    ...
    <div className="comment-container">
      ...
      <div className="comment-section">
        <div className="comment">
          ...
          <div className="vote">
            <button
              onMouseEnter={voteUpHover}
              onMouseLeave={voteUpHover}
              onClick={voteUp}
            >
              <ExpandLessIcon fontSize={voteUpHovered ? "medium" : "small"} />
            </button>
            <span>{votes}</span>
            <button
              onMouseEnter={voteDownHover}
              onMouseLeave={voteDownHover}
              onClick={voteDown}
            >
              <ExpandMoreIcon fontSize={voteDownHovered ? "medium" : "small"} />
            </button>
          </div>

          <p>
            For the people who have the account page black when you just create
            the account...
          </p>
